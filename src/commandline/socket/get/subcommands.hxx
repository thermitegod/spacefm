...
void screen_size(CLI::App* app, const socket_subcommand_data_t& opt) noexcept;
...
void tab_count(CLI::App* app, const socket_subcommand_data_t& opt) noexcept;
...
void statusbar_text(CLI::App* app, const socket_subcommand_data_t& opt) noexcept;
