...
void
gui::action::trash_files(Gtk::ApplicationWindow& parent,
                         ...
                         const std::shared_ptr<config::settings>& settings) noexcept
{
    ...
    if (settings->general.confirm_trash)
    {
        auto* dialog =
            Gtk::make_managed<gui::dialog::action>(parent, "Trash selected files?", selected_files);
