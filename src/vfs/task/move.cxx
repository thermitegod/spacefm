...
vfs::move&
vfs::move::source(const std::filesystem::path& path) noexcept
{
    if (path.empty())
    {
...
vfs::move&
vfs::move::destination(const std::filesystem::path& path) noexcept
{
    if (path.empty())
    {
