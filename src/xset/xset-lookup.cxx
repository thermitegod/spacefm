...
static const std::unordered_map<xset::name, std::string_view> xset_name_map{
    ...
    // handlers arc
    {xset::name::handler_archive_7z,          "handler_archive_7z"sv},
    {xset::name::handler_archive_gz,          "handler_archive_gz"sv},
    {xset::name::handler_archive_rar,         "handler_archive_rar"sv},
    {xset::name::handler_archive_tar,         "handler_archive_tar"sv},
    {xset::name::handler_archive_tar_bz2,     "handler_archive_tar_bz2"sv},
    {xset::name::handler_archive_tar_gz,      "handler_archive_tar_gz"sv},
    {xset::name::handler_archive_tar_lz4,     "handler_archive_tar_lz4"sv},
    {xset::name::handler_archive_tar_xz,      "handler_archive_tar_xz"sv},
    {xset::name::handler_archive_tar_zst,     "handler_archive_tar_zst"sv},
    {xset::name::handler_archive_lz4,         "handler_archive_lz4"sv},
    {xset::name::handler_archive_xz,          "handler_archive_xz"sv},
    {xset::name::handler_archive_zip,         "handler_archive_zip"sv},
    {xset::name::handler_archive_zst,         "handler_archive_zst"sv},

    // handlers file
    {xset::name::handler_file_iso,            "handler_file_iso"sv},

    // handlers fs
    {xset::name::handler_filesystem_default,  "handler_filesystem_default"sv},
    {xset::name::handler_filesystem_fuseiso,  "handler_filesystem_fuseiso"sv},
    {xset::name::handler_filesystem_udiso,    "handler_filesystem_udiso"sv},

    // handlers net
    {xset::name::handler_network_ftp,         "handler_network_ftp"sv},
    {xset::name::handler_network_fuse,        "handler_network_fuse"sv},
    {xset::name::handler_network_fusesmb,     "handler_network_fusesmb"sv},
    {xset::name::handler_network_gphoto,      "handler_network_gphoto"sv},
    {xset::name::handler_network_http,        "handler_network_http"sv},
    {xset::name::handler_network_ifuse,       "handler_network_ifuse"sv},
    {xset::name::handler_network_mtp,         "handler_network_mtp"sv},
    {xset::name::handler_network_ssh,         "handler_network_ssh"sv},
    {xset::name::handler_network_udevil,      "handler_network_udevil"sv},
    {xset::name::handler_network_udevilsmb,   "handler_network_udevilsmb"sv},
