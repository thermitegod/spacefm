...
const std::unordered_map<xset::panel, panel_lookup_data> xset_panel_lookup{
    ...
    },
    {
        ...
        {
            {
                xset::name::panel1_icon_tab,
                xset::name::panel2_icon_tab,
                xset::name::panel3_icon_tab,
                xset::name::panel4_icon_tab,
            },
            {{
                {
                    xset::name::panel1_icon_tab0,
                    xset::name::panel1_icon_tab1,
                    xset::name::panel1_icon_tab2,
                    xset::name::panel1_icon_tab3,
                },
                {
                    xset::name::panel2_icon_tab0,
                    xset::name::panel2_icon_tab1,
                    xset::name::panel2_icon_tab2,
                    xset::name::panel2_icon_tab3,
                },
                {
                    xset::name::panel3_icon_tab0,
                    xset::name::panel3_icon_tab1,
                    xset::name::panel3_icon_tab2,
                    xset::name::panel3_icon_tab3,
                },
                {
                    xset::name::panel4_icon_tab0,
                    xset::name::panel4_icon_tab1,
                    xset::name::panel4_icon_tab2,
                    xset::name::panel4_icon_tab3,
                },
            }},
        },
    },
    {
        ...
        {
            {
                xset::name::panel1_icon_status,
                xset::name::panel2_icon_status,
                xset::name::panel3_icon_status,
                xset::name::panel4_icon_status,
            },
            {{
                {
                    xset::name::panel1_icon_status0,
                    xset::name::panel1_icon_status1,
                    xset::name::panel1_icon_status2,
                    xset::name::panel1_icon_status3,
                },
                {
                    xset::name::panel2_icon_status0,
                    xset::name::panel2_icon_status1,
                    xset::name::panel2_icon_status2,
                    xset::name::panel2_icon_status3,
                },
                {
                    xset::name::panel3_icon_status0,
                    xset::name::panel3_icon_status1,
                    xset::name::panel3_icon_status2,
                    xset::name::panel3_icon_status3,
                },
                {
                    xset::name::panel4_icon_status0,
                    xset::name::panel4_icon_status1,
                    xset::name::panel4_icon_status2,
                    xset::name::panel4_icon_status3,
                },
            }},
        },
    },
    ...
    },
    {
        ...
        {
            {
                xset::name::panel1_detcol_date,
                xset::name::panel2_detcol_date,
                xset::name::panel3_detcol_date,
                xset::name::panel4_detcol_date,
            },
            {{
                {
                    xset::name::panel1_detcol_date0,
                    xset::name::panel1_detcol_date1,
                    xset::name::panel1_detcol_date2,
                    xset::name::panel1_detcol_date3,
                },
                {
                    xset::name::panel2_detcol_date0,
                    xset::name::panel2_detcol_date1,
                    xset::name::panel2_detcol_date2,
                    xset::name::panel2_detcol_date3,
                },
                {
                    xset::name::panel3_detcol_date0,
                    xset::name::panel3_detcol_date1,
                    xset::name::panel3_detcol_date2,
                    xset::name::panel3_detcol_date3,
                },
                {
                    xset::name::panel4_detcol_date0,
                    xset::name::panel4_detcol_date1,
                    xset::name::panel4_detcol_date2,
                    xset::name::panel4_detcol_date3,
                },
            }},
        },
    },
